...
try:
    ...
    select_query = '''
        ...
        WHERE 
            ...
            --AND t.num_domicialiation in ('1128544','11997','1881904','776009','4707876','170225','776613')
        ORDER BY 
    ...
    for row in pg_rows:
        ...
        cursor_sql.execute("SELECT Titre_Num FROM xtitre where Titre_Num = '" + titre_num + "'")
        ...
        if titre_num not in existing_xtitre:
            for record in new_records:
                ...
                queryFindTiers = "SELECT * FROM tiers WHERE (Tiers_Type = '07' OR Tiers_Type = '02' OR Tiers_Type = '01') AND (" + " OR ".join(original_string) + ")"
                ...
                if hasFindTiers == True and isNewTitre == 1:
                    ...
                    message.attach(MIMEText("Client/Fourniseur Non trouver" + record[6] + " (" + database_sql + " )\nTitre Non inserrer Num:" + titre_num + "\n" + "Type Dossier:" + TypeDoss , "plain"))
