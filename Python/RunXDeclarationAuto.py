...
try:
	...
	douane_data.code_devise_montant_devise as cours,
...
where douane_data.num_enreg_ddm <> '' and cm.numero_domiciliation <> ''  and g.type_transaction  = 1
    ...
    # Insertion des Titres ###############
        ...
        for record in new_records:
            ...
            if len(FindTiersExecute) > 0 and len(FindTiersExecute[0]) > 2:
                print("FindTiersExecute is empty!")
